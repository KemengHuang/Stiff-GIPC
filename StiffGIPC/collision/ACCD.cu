...
__device__ int _dType_point_triangle(const double3& v0,
                                     const double3& v1,
                                     const double3& v2,
                                     const double3& v3)
{
...
__device__ int _dType_edge_edge(const double3& v0, const double3& v1, const double3& v2, const double3& v3)
{
...
__device__ __forceinline__ double point_point_distance(const double3& v0, const double3& v1)
{
    return __GEIGEN__::__squaredNorm(__GEIGEN__::__minus(v0, v1));
}

__device__ __forceinline__ double point_triangle_distance(const double3& v0,
                                                          const double3& v1,
                                                          const double3& v2,
                                                          const double3& v3)
{
...
__device__ __forceinline__ double point_edge_distance(const double3& v0,
                                                      const double3& v1,
                                                      const double3& v2)
{
    return __GEIGEN__::__squaredNorm(__GEIGEN__::__v_vec_cross(
               __GEIGEN__::__minus(v1, v0), __GEIGEN__::__minus(v2, v0)))
           / __GEIGEN__::__squaredNorm(__GEIGEN__::__minus(v2, v1));
}

__device__ __forceinline__ double edge_edge_distance(const double3& v0,
                                                     const double3& v1,
                                                     const double3& v2,
                                                     const double3& v3)
{
...
__device__ __forceinline__ double _d_EEParallel(const double3& v0,
                                                const double3& v1,
                                                const double3& v2,
                                                const double3& v3)
{
...
__device__ double edge_edge_distance_unclassified(const double3& ea0,
                                                  const double3& ea1,
                                                  const double3& eb0,
                                                  const double3& eb1)
{
...
__device__ double point_triangle_distance_unclassified(const double3& p,
                                                       const double3& t0,
                                                       const double3& t1,
                                                       const double3& t2)
{
...
__device__ double edge_edge_ccd(const double3& _ea0,
                                const double3& _ea1,
                                const double3& _eb0,
                                const double3& _eb1,
                                const double3& _dea0,
...
__device__ double point_triangle_ccd(const double3& _p,
                                     const double3& _t0,
                                     const double3& _t1,
                                     const double3& _t2,
                                     const double3& _dp,
...
inline __device__ bool _insideTriangle(double3 a, double3 b, double3 c, double3 p)
{
    ...
    if((wa = __GEIGEN__::__v_vec_dot(__GEIGEN__::__v_vec_cross(db, dc), n)) < 0.0f)
        return false;
    if((wb = __GEIGEN__::__v_vec_dot(__GEIGEN__::__v_vec_cross(dc, da), n)) < 0.0f)
        return false;
    if((wc = __GEIGEN__::__v_vec_dot(__GEIGEN__::__v_vec_cross(da, db), n)) < 0.0f)
        return false;
...
inline __device__ void _equateCubic_VF(double3       a0,
                                       double3       ad,
                                       double3       b0,
                                       double3       bd,
                                       double3       c0,
                                       ...
                                       const double& thickness)
{
    ...
    dab = __GEIGEN__::__minus(bd, ad), dac = __GEIGEN__::__minus(cd, ad),
    dap = __GEIGEN__::__minus(pd, ad);
    oab = __GEIGEN__::__minus(b0, a0), oac = __GEIGEN__::__minus(c0, a0),
    oap = __GEIGEN__::__minus(p0, a0);
    ...
    b = __GEIGEN__::__v_vec_dot(oap, dabXdac)
        + __GEIGEN__::__v_vec_dot(dap, __GEIGEN__::__add(dabXoac, oabXdac));
    c = __GEIGEN__::__v_vec_dot(dap, oabXoac)
        + __GEIGEN__::__v_vec_dot(oap, __GEIGEN__::__add(dabXoac, oabXdac));
    d = thickness * __GEIGEN__::__v_vec_dot(oap, oabXoac);
}

inline __device__ double IntersectVF(double3       ta0,
                                     double3       tb0,
                                     double3       tc0,
                                     double3       ad,
                                     double3       bd,
                                     ...
                                     const double& thickness)
{
    ...
    for(int i = 0; i < num; i++)
    {
        ...
        if(_insideTriangle(__GEIGEN__::__add(__GEIGEN__::__s_vec_multiply(ad, r), ta0),
...
__device__ double doCCDVF(const double3& _p,
                          const double3& _t0,
                          const double3& _t1,
                          const double3& _t2,
                          const double3& _dp,
