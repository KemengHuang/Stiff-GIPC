...
gipc::cuda::CBufferView<double3> ABDSimData::unique_point_id_to_position() const
{
    auto offset = abd_fem_count_info().abd_point_offset;
    auto num    = abd_fem_count_info().abd_point_num;
    return gipc::cuda::CBufferView<double3>{m_tet.vertexes, m_gipc.vertexNum}.subview(offset, num);
}

gipc::cuda::CBufferView<I32> ABDSimData::unique_point_id_to_body_id() const
{
    auto offset = abd_fem_count_info().abd_point_offset;
    auto num    = abd_fem_count_info().abd_point_num;
    return gipc::cuda::CBufferView<I32>{m_tet.point_id_to_body_id, m_gipc.vertexNum}.subview(offset, num);
}

gipc::cuda::CBufferView<Float> ABDSimData::tet_id_to_volume() const
{
    auto offset = abd_fem_count_info().abd_tet_offset;
    auto num    = abd_fem_count_info().abd_tet_num;
    return gipc::cuda::CBufferView<Float>{m_tet.volum, m_gipc.tetrahedraNum}.subview(offset, num);
}
gipc::cuda::CBufferView<I32> ABDSimData::point_id_to_unique_point_id() const
{
...
gipc::cuda::CBufferView<TetLocalInfo> ABDSimData::tet_info() const
{
    auto offset = abd_fem_count_info().abd_tet_offset;
    auto num    = abd_fem_count_info().abd_tet_num;
    return m_tet_info.view(offset, num);
}
gipc::cuda::CBufferView<I32> ABDSimData::tet_id_to_body_id() const
{
    auto offset = abd_fem_count_info().abd_tet_offset;
    auto num    = abd_fem_count_info().abd_tet_num;
    return gipc::cuda::CBufferView<I32>{m_tet.tet_id_to_body_id, m_gipc.tetrahedraNum}.subview(offset, num);
}
gipc::cuda::CBufferView<BodyBoundaryType> ABDSimData::body_id_to_boundary_type() const
{
    auto offset = abd_fem_count_info().abd_body_offset;
    auto num    = abd_fem_count_info().abd_body_num;
    return gipc::cuda::CBufferView<BodyBoundaryType>{m_tet.body_id_to_boundary_type,
...
void ABDSimData::upload()
{
    ...
    auto tets = gipc::cuda::CBufferView<uint4>{m_tet.tetrahedras, m_gipc.tetrahedraNum};
